...
public class ConfigManager {
    ...
    public String replacePlaceholders(String text, Player player) {
        ...
        // RAM placeholders (the memory hogs)
        text = text.replace("{ram_used}", String.valueOf(plugin.getRamTracker().getUsedRamMB()));
        text = text.replace("{ram_max}", String.valueOf(plugin.getRamTracker().getMaxRamMB()));
        text = text.replace("{ram_free}", String.valueOf(plugin.getRamTracker().getFreeRamMB()));
        text = text.replace("{ram_percent}", String.valueOf(plugin.getRamTracker().getRamUsagePercent()));
        text = text.replace("{ram_usage}", plugin.getRamTracker().getFormattedRamUsage());
        text = text.replace("{ram_usage_percent}", plugin.getRamTracker().getFormattedRamUsageWithPercent());
